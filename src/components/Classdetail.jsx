        ...
        <div className="container">
              ...
              <div className="col-lg-5">
                <div className="payment-detail">
                  ...
                  <ul class="class-info-list">
                    <li><h4> Course Price: <span class="price">{classdatas.courseprice}</span> <sub class="unit">/month</sub></h4></li>
                    <li><h4>Course Duration:<span class="item">{classdatas.duration}</span></h4></li>
                    <li><h4>Class Intensity:<span class="item">{classdatas.intensity}</span></h4></li>
                    <li><h4>Class Name:<span class="item">{classdatas.title}</span></h4></li>
                    </ul>
                    <div class="class-btn"><a href="#" class="btn-style"><span>JOIN NOW<i class="bi bi-arrow-right"></i></span></a></div>
          ...
          <div className="content-box">
            <div className="row">
              <div className="col-lg-12 col-mg-12 col-sm-12">
                ...
                <p>
                  Authoritatively disseminate multimedia based total linkage through market-driven metho dologies. Continually transform integrated results vis-a-vis multidisciplinary manufacture products. Appropriately foster fully researched innovation rather than backend supply chains results vis-a-vis multidisciplin ary manufactured.
                </p>
              </div>
            </div>
          </div>
          <div className="things-bring">
            <div className="row">
              ...
              <p>Authoritatively disseminate multimedia based total linkage through market-driven metho dologies. Continually transform integrated results.</p>
              <div className="things">
                <div className="row">
                  ...
                  <div className="col-lg-3">
                       <div className="info-box">
                      <div className="info-thing">
                        <span><i class="fa-solid fa-toilet-paper"></i></span>
